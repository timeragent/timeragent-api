...
use App\GraphQL\InputTypes\TaskInputType;
use App\GraphQL\InputTypes\TimeEntryInputType;
use App\GraphQL\InputTypes\MembersInputType;
...
use App\GraphQL\Mutation\Task\CreateTaskMutation;
use App\GraphQL\Mutation\Task\UpdateTaskMutation;
use App\GraphQL\Mutation\Task\DeleteTaskMutation;
use App\GraphQL\Mutation\TimeEntry\CreateTimeEntryMutation;
use App\GraphQL\Mutation\TimeEntry\UpdateTimeEntryMutation;
use App\GraphQL\Mutation\TimeEntry\DeleteTimeEntryMutation;
use App\GraphQL\Mutation\Organization\UpdateOrganizationMembersMutation;
use App\GraphQL\Mutation\User\LoginUserMutation;
...
use App\GraphQL\Query\Task\TasksQuery;
...
use App\GraphQL\Type\TimeEntryType;
...
//        'auth:api',
    ...
    'schemas'               => [
        'auth' => [
            ...
            'mutation'     => [
                ...
                UpdateOrganizationMembersMutation::class,
                ...
                CreateTimeEntryMutation::class,
                UpdateTimeEntryMutation::class,
                DeleteTimeEntryMutation::class,
    ...
    'types'                 => [
        ...
        TaskInputType::class,
        TimeEntryInputType::class,
        MembersInputType::class,
    ],
