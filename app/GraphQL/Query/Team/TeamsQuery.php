...
class TeamsQuery extends Query
{
    ...
    {
        return [
            'team_uuid'       => ['name' => 'team_uuid', 'type' => Type::string()],
    ...
    public function resolve($root, $args)
    {
        ...
        if (isset($args['owner_type']) && isset($args['owner_uuid']) && isset($args['user_uuid'])) {
            $query->getTeams($args['owner_type'], $args['owner_uuid'], $args['user_uuid']);
